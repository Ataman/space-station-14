...
namespace Content.Client.Instruments.UI
{
    ...
    public sealed partial class InstrumentMenu : FancyWindow
    {
        ...
        private InstrumentMidiSourceControl? _currentMode;
        ...
        protected override void ExitedTree()
        {
            ...
            ChannelsControl.ClearInstrument();
        ...
        private void SetupSources(params InstrumentMidiSourceControl[] modes)
        {
        ...
        private void SwitchMode(InstrumentMidiSourceControl mode)
        {
            if (_currentMode != null)
            {
            ...
            ChannelsControl.ClearChannelList();
        }
        ...
        public void SetInstrument(Entity<InstrumentComponent> entity)
        {
            ...
            ChannelsControl.SetInstrument(entity);
            if (_currentMode != null)
            {
                _currentMode.SetInstrument(entity);
            }
